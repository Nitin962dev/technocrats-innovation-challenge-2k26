...
export default function AppLayout() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-slate-50 relative overflow-hidden shadow-2xl ring-1 ring-slate-900/5 sm:rounded-3xl sm:h-[90vh] sm:mt-[5vh]">
      {/* Top App Bar Simulator */}
      <div className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md z-10 sticky top-0 border-b border-purple-100">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-600 to-fuchsia-500 flex items-center justify-center p-1.5 text-white">
            <Shield className="w-full h-full" strokeWidth={2.5} />
          </div>
          <h1 className="text-xl font-bold bg-gradient-to-r from-purple-700 to-fuchsia-600 bg-clip-text text-transparent tracking-tight">
            {t('app_name')}
          </h1>
        </div>
